...
public class AddApptActionTest extends TestCase {
	...
	public void testAddConflicts() throws SQLException, FormValidationException, FileNotFoundException, IOException{
		gen.clearAllTables();
		gen.appointmentType();
	...
	public void testGetConflicts() throws SQLException, FormValidationException, FileNotFoundException, IOException{
		gen.clearAllTables();
		gen.appointmentType();
		ApptBean a = new ApptBean();
		a.setApptType("General Checkup");

...
public class WardCRUDServletTest extends TestCase {
	...
	public void testWardCRUDServletPost() throws Exception {
	...
	public void testWardCRUDServletPostFail() throws Exception {
		LittleDelegatorServlet servlet = new LittleDelegatorServlet();
		servlet.setUp();
	...
	public void testWardCRUDServletPut() throws Exception {
		LittleDelegatorServlet servlet = new LittleDelegatorServlet();
		servlet.setUp();
